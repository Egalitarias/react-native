...
export default class App extends Component<Props> {
  ...
  subscribe() {
    ...
    this.setState({ value: 0, message: "Subscribed" });
  }
  ...
  unsubscribe() {
    ...
    this.setState({ value: 0, message: "Unsubscribed" });
  }
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <Padding styles={styles} />
        <Message styles={styles}>{this.state.value || 0}</Message>
        <Padding styles={styles} />
